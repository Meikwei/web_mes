...
import { getPageList } from "/@/api/bom";
// @ts-ignore
...
<template>
  <div class="welcome">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form
          ...
          label-width="140px"
        >
          <el-form-item label="物料编号：" prop="keyword">
            <el-input
              v-model="params.listQuery.partNo"
              class="input-width"
              placeholder="物料编号"
              clearable
            ></el-input>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <Upload class="btn-add" @changePage="getList" />
    </el-card>
    <div class="table-container">
      <el-table
        ...
        border
      >
        <el-table-column label="物料编号" align="center" prop="partNo" />

        <el-table-column label="版本" align="center" prop="bomVersion" />
