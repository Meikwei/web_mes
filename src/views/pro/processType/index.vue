...
import { getPageList } from "/@/api/processType";
  ...
  <div class="welcome">
      ...
      <div style="margin-top: 15px">
        ...
        >
          <el-form-item label="输入搜索：" prop="keyword">
            <el-input
              v-model="params.listQuery.keyword"
              class="input-width"
              placeholder="制程类型名称"
              clearable
            ></el-input>
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="制程类型名称" align="center" prop="typeName" />
        <el-table-column label="制程常量" align="center" prop="typeCode" />
        <el-table-column label="描述" align="center" prop="typeDescription" />
        <el-table-column
          label="创建时间"
          width="160"
          align="center"
