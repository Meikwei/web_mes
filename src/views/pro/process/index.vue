...
import { getPageList } from "/@/api/process";
  ...
  <div class="welcome">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="容器类型" align="center" prop="typeId" />
        <el-table-column label="不良" align="center" prop="defectFlag" />
        <el-table-column label="混包" align="center" prop="mixWo" />
        <el-table-column
          label="创建时间"
          width="160"
          align="center"
